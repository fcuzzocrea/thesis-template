...
By default, in fact, \acrshort{povray} uses \inlinecode{POV}{<0,1,0>} as \inlinecode{POV}{sky} vector. By redefining it as \inlinecode{POV}{<0,0,1>}  \acrshort{povray} will roll the camera until the top of the camera is in line with the \inlinecode{POV}{sky} vector, giving us the desired reference frame.

\begin{figure}
  \centering
  \subfloat[\acrshort{povray} standard coordinate system]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesNormal.eps}}
  \qquad
  \subfloat[Result after imposing negative x to the \inlinecode{POV}{right} vector ]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesAfterRight.eps}}
  \qquad
  \subfloat[Result after imposing \inlinecode{POV}{<0,0,1>} to the \inlinecode{POV}{sky} vector]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesSky.eps}}
...
So, by knowing how \acrshort{povray} rotates the camera to point to the the \inlinecode{POV}{look_at} point, we can compute the actual attitude matrix of the camera with respect to the "inertial" \acrshort{povray} world by exploiting simple linear algebra rules:
...
\subsection{Adding the noise}\label{subsection:addingthenoise}
...
\begin{figure}[H]
  \centering
  \subfloat[Image without noise added]{\includegraphics[width=0.45\textwidth]{gfx/tangoNoNoise.eps}}
  \qquad
  \subfloat[Image wit speckle and Gaussian white noise]{\includegraphics[width=0.45\textwidth]{gfx/tangoNoise.eps}}
...
\begin{figure}[H]
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_14.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_15.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_31.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_60.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_259.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tango/tango_268.eps}}
...
\begin{table}[H]
  ...
  \begin{tabular}{ccc}
    ...
    \hline
  \end{tabular}
  \caption{Parameters used to generate the reference orbit}
