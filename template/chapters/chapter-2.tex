...
The \acrshort{sc} which has been modeled is heavily inspired by the Tango \acrshort{sc} of the PRISMA mission \footnote{More details about the PRISMA mission can be found at \url{https://earth.esa.int/web/eoportal/satellite-missions/p/prisma-prototype}}, by ESA.
