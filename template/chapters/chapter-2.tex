...
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/povrayTern.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/povrayHand.eps}}
...
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/axesLeft.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/axesRight.eps}}
...
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesNormal.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesAfterRight.eps}}
  \qquad
  \subfloat[]{\includegraphics[width=0.4\textwidth]{gfx/tangoAxesSky.eps}}
  \caption{Right Handed Coordinate System and Left Handed Coordinate System}
...
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=0.45\textwidth]{gfx/tangoNoNoise.eps}}
  \qquad
