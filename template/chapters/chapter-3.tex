...
\begin{figure}[htbp]
  \centering
  \subfloat[Original image]{\includegraphics[width=0.45\textwidth]{gfx/FeatureDetection/chosenImage.eps}}
  \qquad
  \subfloat[Gradient detection of original image]{\includegraphics[width=0.45\textwidth]{gfx/FeatureDetection/gradientBeforeTresholding.eps}}
  \qquad
  \subfloat[Histogram of normalized gradient values]{\includegraphics[width=0.45\textwidth]{gfx/FeatureDetection/gradientDistribution.eps}}
  \qquad
  \subfloat[Output filtered image gradients]{\includegraphics[width=0.45\textwidth]{gfx/FeatureDetection/imageAfterTresholding.eps}}
...
\begin{figure}[htbp]
  \centering
  \subfloat[\acrshort{roi} selected by considering only the central $90\%$ of the normal distribution]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/ROInoConstant.eps}}
  \qquad
  \subfloat[\acrshort{roi} enlarged by adding the $5\%$ of the mean edge length of the previously \acrshort{roi}]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/enlargedROI.eps}}
...
\begin{figure}[htbp]
  \centering
  \subfloat[Original edge]{\includegraphics[width=0.47\textwidth]{gfx/segmentsPreMerge.eps}}
  \qquad
  \subfloat[Output merged edge]{\includegraphics[width=0.47\textwidth]{gfx/segmentsAfterMerge.eps}}
  \qquad
...
\begin{figure}[htbp]
  \centering
  \subfloat[\acrshort{wge} output]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/wgeHough.eps}}
  \qquad
  \subfloat[\acrshort{wge} output after merging truncated edges]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/wgeMerged.eps}}
  \qquad
  \subfloat[\acrshort{seh} output]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/seHough.eps}}
  \qquad
...
\begin{figure}[htbp]
  \centering
  \subfloat[\acrshort{wge} output]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/wgeHough3.eps}}
  \qquad
  \subfloat[\acrshort{wge} output after merging truncated edges]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/wgeMerged3.eps}}
  \qquad
  \subfloat[\acrshort{seh} output]{\includegraphics[width=0.47\textwidth]{gfx/FeatureDetection/seHough3.eps}}
  \qquad
...
\begin{figure}[htbp]
  \centering
  \subfloat[Map superposed to the image]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/trial49modelMap.eps}}
  \qquad
  \subfloat[\acrshort{3d} camera pose in map coordinates]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/cameraWRTSC49.eps}}
  \qquad
  \subfloat[Map superposed to the image]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/trial214modelMap.eps}}
  \qquad
  \subfloat[\acrshort{3d} camera pose in map coordinates]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/cameraWRTSC214.eps}}
  \qquad
  \subfloat[Map superposed to the image]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/trial212modelMap.eps}}
  \qquad
  \subfloat[\acrshort{3d} camera pose in map coordinates]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/cameraWRTSC212.eps}}
  \qquad
  \subfloat[Map superposed to the image]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/trial311modelMap.eps}}
  \qquad
  \subfloat[\acrshort{3d} camera pose in map coordinates]{\includegraphics[width=0.45\textwidth]{gfx/PoseDetermination/cameraWRTSC311.eps}}
  \qquad
