...
\newglossaryentry{A_CN}{name=${A_{CN}}$,description={Orientation of the camera frame with respect to the inertial frame}}
\newglossaryentry{A_TN}{name=${A_{TN}}$,description={Orientation of the target principal axes with respect to the inertial frame}}
\newglossaryentry{A_TC}{name=${A_{TC}}$,description={Orientation of target principal axes with respect to the camera frame}}
\newglossaryentry{t_c}{name=${t_C}$,description={Target center of mass location with respect to camera frame}}
