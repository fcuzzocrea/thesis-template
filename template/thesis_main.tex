...
\newacronym{gci}{ECI}{Earth Centered Inertial}
...
\hypersetup{
    ...
    pdftitle   = {Analysis and validation of spaceborne synthetic imagery using a Vision-Based pose initialization algorithm for non-cooperative spacecrafts},    				% title
...
\input{./initial-final-stuff/authorship.tex}
\cleardoublepage{}
...
\input{./initial-final-stuff/hostcompany.tex}
\cleardoublepage{}
...
\cleardoublepage{}
%%% Appendix B
\chapter{Common \acrshort{cv} Models and Problems \label{app:second-appendix}}
